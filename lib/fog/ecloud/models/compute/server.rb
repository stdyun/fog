    ...
    class Ecloud
      class Server < Fog::Ecloud::Model
        ...
        def hardware_configuration
          @hardware_configuration ||= Fog::Compute::Ecloud::HardwareConfigurations.new(:service => service, :href => "/cloudapi/ecloud/virtualMachines/#{id}/hardwareConfiguration")[0]
        end
        ...
        def ips
          ...
          @ips = nil
          networks = Fog::Compute::Ecloud::Networks.new(:service => service, :href => "/cloudapi/ecloud/virtualMachines/#{id}/assignedIps")
        ...
        def add_ip(options)
          ...
          data = service.virtual_machine_add_ip(href + "/assignedIps", slice_networks).body
          task = Fog::Compute::Ecloud::Tasks.new(:service => service, :href => data[:href])[0]
        end
